...
/**
 * 検索結果リスト用のセル。ファイル名のみ表示し、ドラッグ＆ドロップで外部に渡す。
 */
public class SearchResultListCell extends ListCell<File> {

    private final Label nameLabel = new Label();
    private final Region spacer = new Region();
    private final HBox container = new HBox(10, nameLabel, spacer);
